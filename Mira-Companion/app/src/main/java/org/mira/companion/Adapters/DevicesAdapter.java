 ...
 */
public class DevicesAdapter extends BaseQuickAdapter<Downloadable, BaseViewHolder> {

    public DevicesAdapter(Activity activity, List<Downloadable> listOfDownloadables) {
